    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String message = "HELLO HYY!";
                SmsManager smsManager = SmsManager.getDefault();
                if (!mob1.isEmpty()) smsManager.sendTextMessage(mob1, null, message, null, null);
                if (!mob2.isEmpty()) smsManager.sendTextMessage(mob2, null, message, null, null);
                if (!mob3.isEmpty()) smsManager.sendTextMessage(mob3, null, message, null, null);
